---
title: nextjs 构建极简博客
createdAt: 2024-03-17 11:42:35
updatedAt: 2024-03-17 11:42:35
description: 使用Nextjs初始化项目，使用MDX构建Markdown解析，构建一个简单的博客基础模版。
published: true
---
...
这里主要借助`next-mdx-remote`加载和显示MDX文件，另外说明一下MDX有两大插件系统：
